...
class SegFormerHead(nn.Module):
    ...
    def __init__(self, inChannels=[64, 128, 320, 512], feature_strides=[4, 8, 16, 32], dropout_ratio=0.1, act_layer=nn.ReLU, num_classes=20, embed_dim=768, align_corners=False, ddp=False):
        ...
        self.norm = norm_layer(embed_dim) if ddp else nn.BatchNorm2d()
        self.act = act_layer()
