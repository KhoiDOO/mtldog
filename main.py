...
if __name__ == "__main__":
    ...
    parser.add_argument('--dt', type=str, required=False, help='data directory')
    ...
    # task
    parser.add_argument('--trdms', type=str, nargs='+', required=True, help='list of domain used in training')
